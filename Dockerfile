...
##   $ docker build -t node-js-for-patong167-nicistore .
##
## RUNNING
##   $ docker run -p 3000:3000 node-js-for-patong167-nicistore
##
## CONNECTING
...
ENV STACKSMITH_STACK_ID="lzrzyby" \
    STACKSMITH_STACK_NAME="Node.js for patong167/nicistore" \
